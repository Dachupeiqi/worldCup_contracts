...
contract WorldCupDistributor {
    ...
    /// @notice  user  claimed  reward with proof（用户领取token激励）
    ...
    function claim(
        ...
        emit Claimed(address(this), user, amount,index);
    }
    ...
    /// @notice  owner withdraw the rest token（管理员提利润）
